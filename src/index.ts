...
//   해당 생년월일을 기반으로 운세(서양 별자리(별자리), 한국·중국 띠(연도 기반), 간단한 오늘의 운세 및 추천 행동 포함)를 제공하십시오.
// - 모든 운세 응답은 한국어로 작성하고 점검한 사실/출처가 있다면 표기하십시오.
// - 운세 출력은 가능한 경우 다음 형식을 따르십시오(간결하게):
//   1) 요약(한 문장) 2) 별자리(서양) 3) 띠(중국/한국) 4) 오늘의 운세(요약 + 추천 행동) 5) 확신도(확신도: 높음/보통/낮음) 6) 참고(출처 또는 검증 방법)
